...
def config_oc_bgp_ipv4():
    ...
    protocol.bgp.global_.afi_safis.afi_safi.afi_safi_name = "ipv4 unicast"
    protocol.bgp.peer_groups.peer_group.peer_group_name = "IBGP"
    protocol.bgp.neighbors.neighbor.neighbor_address = "172.16.4.1"
    protocol.bgp.neighbors.neighbor.remote_as = 65000
